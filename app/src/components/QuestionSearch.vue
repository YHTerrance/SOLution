...
<template>
  <div class="relative border-b">
    <input
      type="text"
      class="text-gray-700 w-full pl-16 pr-32 py-4 bg-gray-50 dark:bg-pink-100/20 dark:text-white !ring-pink-300 !border-0"
    ...
    <div
      ...
      :class="modelValue ? 'text-gray-700 dark:text-gray-100' : 'text-gray-400'"
    >
      <slot name="icon"></slot>
    </div>
